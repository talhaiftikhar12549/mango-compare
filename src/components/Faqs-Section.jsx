...
export default function FaqsSection({ items }) {
  ...
  return (
    <>
      <section className="max-w-[1280px] flex flex-col justify-start w-[70%] pt-[88px] pb-[200px]">
        <div className="w-full pb-[56px]">
          <h2 className="text-[56px] font-[700] text-center font-montserrat text-[#061C3D]">
        ...
        <div className="pt-[56px] flex flex-col gap-y-[16px]">
          {items.map((item, index) => (
            <div
              key={index}
              className={`border w-full border-solid border-[#E6E8EC] p-[24px] ${
