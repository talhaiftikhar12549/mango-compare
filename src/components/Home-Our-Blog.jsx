    ...
    <>
      <section className="max-w-[1280px] w-full py-[100px]">
        ...
        <div className="max-w-[413px]">
            ...
            <h3 className="text-[22px] pt-[20px] pb-[10px] font-[500] font-montserrat text-[#000000]">Lorem ipsum dolor sit amet consectetur. Sed suscipit semper.</h3>
            <p className="text-[14px] font-[400] font-montserrat text-[#5B5C67]">Lorem ipsum dolor sit amet consectetur. Pellentesque arcu nisl at aliquam vitae donec consequat cursus vel. Viverra.</p>
            <h4 className="text-[18px] pt-[10px] font-[600] font-montserrat text-[#FCC821]">Read More</h4>
        </div> 
