...
const AdminDashboard = () => {
  ...
  const fetchListings = async () => {
    try {
      ...
      console.log("api data list", data);
  ...
  useEffect(() => {
    console.log("lets see if file is uploading", formData);  
  }, [formData]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await api.put('/mounjaro/' + editingId, formData);
        console.log('Listing updated successfully', formData);
      } else {
        await api.post('/mounjaro', formData);
        console.log('Listing added successfully', formData);
      }
      fetchListings();
      handleCancelEdit();
    } catch (error) {
